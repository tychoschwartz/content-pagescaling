...
export const cases = [
  {
    ...
    metrics: [
      { v: '1.87M',   l: 'Followers now' },
      { v: '+14.8K',  l: 'Avg / day' },
      { v: '+24.9K',  l: 'Best day' },
    ],
    curve: [0.00, 0.08, 0.17, 0.26, 0.35, 0.45, 0.56, 0.68, 0.82, 1.0],
  ...
  },
  {
    ...
    metrics: [
      { v: '397K',  l: 'Followers now' },
      { v: '+763',  l: 'Avg / day' },
      { v: '+3.0K', l: 'Best day' },
    ],
    curve: [0.28, 0.33, 0.40, 0.47, 0.53, 0.61, 0.69, 0.79, 0.90, 1.0],
    verify: 'Verified on Social Blade',
  },
  {
    n: '03',
    ...
    headline: '390K',
    headlineLabel: 'followers · climbing',
    timeframe: '+4.1K / 14 days',
    metrics: [
      { v: '390K',   l: 'Followers now' },
      { v: '+4.1K',  l: 'Gained · 14d' },
      { v: '0.93%',  l: 'Engagement' },
    ],
    curve: [0.40, 0.42, 0.44, 0.45, 0.47, 0.51, 0.57, 0.66, 0.81, 1.0],
    verify: 'Verified on Social Blade',
  },
  {
    n: '04',
